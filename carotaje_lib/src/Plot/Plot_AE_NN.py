...
def roc_pr_curve_train_and_valid(y_train, y_valid, pred_train_proba, pred_valid_proba, args): 
    ...
    """
    print ('Plotting roc-curve, precisin-recall-curve...')
    ...
    fig.update_layout(legend=dict(bordercolor="Black",borderwidth=2, font=dict(size=14)), plot_bgcolor='white', height=700, width=1450,
                                xaxis=dict(title=dict(text = 'False Positive Rate', font=dict(size=20)),tickfont=dict(size=20), gridcolor = 'lightgrey', 
                                            zerolinecolor = 'lightgrey'),
                                yaxis=dict(title=dict(text='True Positive Rate', font=dict(size=20)), gridcolor = 'lightgrey',
                                            zerolinecolor = 'lightgrey'),
